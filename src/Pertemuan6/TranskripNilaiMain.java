...
public class TranskripNilaiMain {
    public static void main(String[] args) {
        ...
        Dosen dosen3 = new Dosen("Siroj Nur Ulum, S.T., M.T.", "2124129103");
        Dosen dosen4 = new Dosen("Sandika Galih S.T., M.T.", "0425098502");
        ...
        Matakuliah mk3 = new Matakuliah("003","Pemograman Berorientasi Objek", "A", 3, dosen3);
        Matakuliah mk5 = new Matakuliah("005","Pemograman Web", "A", 3, dosen4);
